...
<body class="bg-[#f5feff] w-full h-screen">
        ...
        <main class="w-full h-[90vh] flex px-[5%] gap-4 pt-8">
                ...
                <div id="sections" class="w-full">
                        ...
                        <!-- /*QCM*/ -->
                        <div id="section6" class="section w-full h-full rounded-md flex flex-col gap-4 bg-white p-4 hidden">
                                <div class="flex justify-between items-center">
                                        <h2 class="text-xl font-semibold text-slate-700">Banque de tests</h2>
                                        <div class="flex justify-between items-center gap-6">
                                                <button
                                                        class="text-xs flex justify-between items-center text-white bg-[#00134d] p-2 rounded-md">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="1.5em"
                                                                height="1.5em" viewBox="0 0 24 24">
                                                                <path fill="#fff"
                                                                        d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6z" />
                                ...
                                <div class="relative max-h-full overflow-y-auto scrollbar-hide">
                                                ...
                                                <table class="min-w-full border border-gray-200 rounded-lg">
                                                        ...
                                                        <tbody class="">
                                                                <?php foreach($data_t as $test):?>
                                                                        <tr class="hover:bg-gray-50">
                                                                                <td class="px-4 py-2 text-sm text-slate-500 border-r border-gray-200"><?= $test["id"] ?></td>
                                                                                <td class="px-4 py-2 text-sm text-slate-500 border-r border-gray-200"><?= $test["titre"] ?></td>
                                                                                <td class="px-4 py-2 text-sm text-slate-500 border-r border-gray-200"> <?= $test["created_at"] ?></td>
                                                                                <td class="px-4 py-2 text-sm text-slate-500 flex justify-around items-center">
                                                                                        <a href="qcm_test/?id=<?= $test["id"] ?>" class="cursor-pointer">
                                                                                                <svg
                                        ...
                                        <?php else: ?>
                                                ...
                                                <div class="flex justify-center items-center mt-12">
                                                        <h2 class="text-xl font-semibold text-slate-700">Aucun test disponible</h2>
                                                </div>
                                        <?php endif ?>
                                </div>
                        </div>
                        ...
                        <div id="section4"
                                ...
                                <div class="relative max-full overflow-y-auto scrollbar-hide">
                                                ...
                                                <tbody class="">
                                                        <?php foreach($resultats_candidat as $candidat): ?>
                                                                <?php 
                                                                        ...
                                                                        ?>
                                                                <tr class="hover:bg-gray-50">
                                                                        <td class="px-4 py-2 text-sm text-slate-500 border-r border-gray-200 text-start"><?= htmlspecialchars($candidat['nom_candidat']. " " . $candidat['prenom_candidat'])?></td>
                                                                        <td class="px-4 py-2 text-sm text-slate-500 border-r border-gray-200 text-start"><?= htmlspecialchars($candidat['titre_offre'])?></td>
                                                                        <td class="px-4 py-2 text-sm text-slate-500 border-r border-gray-200 text-start"><?= htmlspecialchars($candidat['titre_test'])?></td>
                                                                        ...
                                                                        <td class="px-4 py-2 text-sm text-slate-500 border-r border-gray-200 text-start"><?= htmlspecialchars($candidat['moyenne'])?></td>
                                                                        <td class="px-4 py-2 text-sm <?= $candidat['statut'] === 'fail' ?"text-red-500" : "text-green-500"?> border-r border-gray-200 text-start"><?= htmlspecialchars($candidat['statut'] === 'fail' ? 'Echoué' : 'Reussi')?></td>
                                                                        <td class="px-4 py-2 text-sm text-slate-500 border-r border-gray-200 text-start"><?= htmlspecialchars($candidat['date_creation'])?></td>
                                        ...
                                        <?php else:?>
                                                ...
                                                <div class="flex justify-center items-center mt-12">
                                                        <h2 class="text-xl font-semibold text-slate-700">Aucun candidat disponible</h2>
                                                </div>
                                        <?php endif ?>
                                </div>
                        </div>

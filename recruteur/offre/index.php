<?php
        require_once('../../scripts/offre.php');
                ...
                <div class="section w-full h-full rounded-md flex flex-col gap-4 p-4 ">
                        ...
                        <div class="flex gap-4 flex-wrap">
                                ...
                                <div class="p-4 w-[45%] h-auto bg-white rounded-md  flex flex-col gap-8">
                                        ...
                                        <button class="shadow-md bg-[#f77313] mt-8 w-50 h-10 flex justify-center items-center rounded-full text-white cursor-pointer hover:bg-[#001436]">Modifier l'offre</button>

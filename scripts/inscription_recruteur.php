...
try {
        ...
        if (
                ...
                $entreprise = htmlspecialchars(trim($data['entreprise']));
                ...
                if (empty($entreprise)  || empty($email) ||  empty($password) || empty($conf_password)) {
                ...
                $sql = "INSERT INTO utilisateurs (id,entreprise, email, mot_de_passe, token, role)
                VALUES (:id, :entreprise, :email, :mot_de_passe, :token, :role)";

const inscription_recruteur_form = document.querySelector('#inscription_recruteur_form');
...
inscription_recruteur_form.addEventListener('submit', async (event) => {
        ...
        if (tousRemplis) {
                if (!verifierMotDePasse(data.password)) {
                        ...
                        try {
                                const response = await fetch('../scripts/inscription_recruteur.php', {
                                        method: 'POST',
                                        headers: {
                                ...
                                if (result.success) {
                                        ...
                                        inscription_recruteur_form.reset();
